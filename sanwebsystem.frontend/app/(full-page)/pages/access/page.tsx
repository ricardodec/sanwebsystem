    ...
    return (
        <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
            <div className="flex flex-column align-items-center justify-content-center">
                <Image src="/demo/images/access/logo-orange.svg" alt="Sanweb logo" className="mb-5 w-6rem flex-shrink-0" width={96} height={96} />
                <div
                    style={{
                        borderRadius: '56px',
                        padding: '0.3rem',
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        ...
                        <Image src="/demo/images/access/asset-access.svg" alt="Error" className="mb-5" width={320} height={240} />
                        <Button icon="pi pi-arrow-left" label="Clique para retornar" text onClick={() => router.push('/')} />
                    </div>
                </div>
            </div>
        </div>
