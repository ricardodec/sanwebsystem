    ...
    return (
        <div className="surface-0 flex justify-content-center">
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center relative lg:static">
                    <Link href="/" className="flex flex-column align-items-center">
                        <div className="flex justify-content-center flex-wrap">
                            <Image src="/layout/images/logo_san.png" alt="SAN Logo" height={45} width={45} className="mr-0 lg:mr-2" />
                        </div>
                        <div className="flex justify-content-center flex-wrap">
                            <span className="text-900 font-bold text-xs line-height-3">WEB SYSTEM</span>
                        </div>
                    </Link>
                    
                    <div className={classNames('surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2', { hidden: isHidden })} style={{ top: '100%' }}>
                        <ul className="list-none p-0 m-0 flex lg:align-items-center select-none flex-column lg:flex-row cursor-pointer">
                            <li>
                                <a href="#home" onClick={onToggleMenuItemClick} className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Home</span>
                                    <Ripple />
                                </a>
                            </li>
                            <li>
                                <a href="#features" onClick={onToggleMenuItemClick} className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Features</span>
                                    <Ripple />
                                </a>
                            </li>
                            <li>
                                <a href="#highlights" onClick={onToggleMenuItemClick} className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Highlights</span>
                                    <Ripple />
                                </a>
                            </li>
                            <li>
                                <a href="#pricing" onClick={onToggleMenuItemClick} className="p-ripple flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3">
                                    <span>Pricing</span>
                                    <Ripple />
                                </a>
                            </li>
                        ...
                        <div className="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
                            <Button label="Conectar" text rounded className="border-none font-light line-height-2 text-blue-500" onClick={onLoginClick}></Button>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="flex justify-content-center md:justify-content-end">
                        <Image src="/demo/images/landing/screen-1.png" alt="Hero Image" width={800} height={600} className="w-9 md:w-auto" />
                    </div>
                </div>
                    ...
                    <div className="grid justify-content-center">
                        ...
                        >
                            <div className="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
                                ...
                                <Image src="/demo/images/landing/peak-logo.svg" width={200} height={50} className="mt-4" alt="Company logo" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="highlights" className="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                    ...
                    <div className="grid mt-8 pb-2 md:pb-8">
                        <div className="flex justify-content-center col-12 lg:col-6 bg-purple-100 p-0 flex-order-1 lg:flex-order-0" style={{ borderRadius: '8px' }}>
                            <Image src="/demo/images/landing/mockup.svg" width={400} height={500} className="w-11" alt="mockup mobile" />
                        </div>
                    ...
                    <div className="grid my-8 pt-2 md:pt-8">
                        ...
                        <div className="flex justify-content-end flex-order-1 sm:flex-order-2 col-12 lg:col-6 bg-yellow-100 p-0" style={{ borderRadius: '8px' }}>
                            <Image src="/demo/images/landing/mockup-desktop.svg" width={600} height={400} className="w-11" alt="mockup" />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid justify-content-between mt-8 md:mt-0">
                        <div className="col-12 lg:col-4 p-0 md:p-3">
                            <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                                ...
                                <Image src="/demo/images/landing/free.svg" width={40} height={40} className="w-10 h-10 mx-auto" alt="free" />
                        ...
                        <div className="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                            <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                                ...
                                <Image src="/demo/images/landing/startup.svg" width={40} height={40} className="w-10 h-10 mx-auto" alt="startup" />
                                <div className="my-5 text-center">
                        ...
                        <div className="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                            <div className="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all">
                                ...
                                <Image src="/demo/images/landing/enterprise.svg" width={40} height={40} className="w-10 h-10 mx-auto" alt="enterprise" />
                                <div className="my-5 text-center">
                    ...
                    <div className="grid justify-content-between">
                        <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
                            <div className="flex flex-column align-items-center">
                                <div className="flex justify-content-center flex-wrap">
                                    <Image src="/layout/images/logo_san.png" alt="SAN Logo" height={60} width={60} />
                                </div>
                                <div className="flex justify-content-center flex-wrap">
                                    <span className="text-900 font-bold text-medium">WEB SYSTEM</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid text-center md:text-left">
                                ...
                                <div className="col-12 md:col-3 mt-4 md:mt-0">
                                    ...
                                    <a className="line-height-3 text-xl block cursor-pointer mb-2 text-700">
                                        Events
                                        <Image src="/demo/images/landing/new-badge.svg" width={20} height={20} className="ml-2" alt="badge" />
                                    </a>
